      ...
      <aside className="w-20 lg:w-64 bg-stone-900 text-stone-50 flex flex-col h-screen sticky top-0 z-[50]">
        ...
        <div className="p-4 border-t border-white/5">
           <button
             ...
             className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl transition-all ${state.view === 'analytics' ? 'bg-white text-stone-900 shadow-xl' : 'text-stone-400 hover:text-white'}`}
           >
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className="hidden lg:block text-xs font-bold uppercase tracking-widest">Executive Profile</span>
           </button>
        </div>
      </aside>

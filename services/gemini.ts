...
/**
 * Sanitizes user input to prevent prompt injection by escaping quotes/backslashes
 * and limiting length.
 */
...
USER INSTRUCTIONS: View: ${sanitizePromptInput(angle)}. Style: "${sanitizePromptInput(style.title)}".`;
